...
class Currency(metaclass=MetaCurrency):
    ...
    def __init__(self, currency: Optional[Union["Currency", str]] = None, decimal_digits: Optional[int] = None, interchangeable_with: Optional[Union[Tuple[str, ...], List[str], Set[str]]] = None, preferred_ticker: Optional[str] = None) -> None:
        if currency and isinstance(currency, Currency):
            ...
            interchangeable_with = currency.interchangeable_with if interchangeable_with is None else interchangeable_with
