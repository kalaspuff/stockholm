...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("4711.33159263 EUR", "4711.33159263 EUR", 4711, 331592630, "EUR", "EUR", "4711.33159263", b"\n\x03EUR\x10\xe7$\x18\xb6\xe7\x8e\x9e\x01"),
        ("-0.001", "-0.001", 0, -1000000, "", None, "-0.001", b"\x18\xc0\xfb\xc2\xff\xff\xff\xff\xff\xff\x01"),
        (-0.001, "-0.001", 0, -1000000, "", None, "-0.001", b"\x18\xc0\xfb\xc2\xff\xff\xff\xff\xff\xff\x01"),
        ("-99 DKK", "-99.00 DKK", -99, 0, "DKK", "DKK", "-99", b"\n\x03DKK\x10\x9d\xff\xff\xff\xff\xff\xff\xff\xff\x01"),
        ("-1.00000502", "-1.00000502", -1, -5020, "", None, "-1.00000502", b"\x10\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x18\xe4\xd8\xff\xff\xff\xff\xff\xff\xff\x01"),
        (-1.00000502, "-1.00000502", -1, -5020, "", None, "-1.00000502", b"\x10\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x18\xe4\xd8\xff\xff\xff\xff\xff\xff\xff\x01"),
        (Money("90909.999999999", currency=Currency.SEK), "90909.999999999 SEK", 90909, 999999999, "SEK", "SEK", "90909.999999999", b"\n\x03SEK\x10\x9d\xc6\x05\x18\xff\x93\xeb\xdc\x03"),
        ("90909.999999999 SEK", "90909.999999999 SEK", 90909, 999999999, "SEK", "SEK", "90909.999999999", b"\n\x03SEK\x10\x9d\xc6\x05\x18\xff\x93\xeb\xdc\x03"),
        ("-90909.999999999 SEK", "-90909.999999999 SEK", -90909, -999999999, "SEK", "SEK", "-90909.999999999", b"\n\x03SEK\x10\xe3\xb9\xfa\xff\xff\xff\xff\xff\xff\x01\x18\x81\xec\x94\xa3\xfc\xff\xff\xff\xff\x01"),
        ("0.999999999 USD", "0.999999999 USD", 0, 999999999, "USD", "USD", "0.999999999", b"\n\x03USD\x18\xff\x93\xeb\xdc\x03"),
        ...
        (-0.999999999, "-0.999999999", 0, -999999999, "", None, "-0.999999999", b"\x18\x81\xec\x94\xa3\xfc\xff\xff\xff\xff\x01"),
        ("-0.9999999990 USD", "-0.999999999 USD", 0, -999999999, "USD", "USD", "-0.999999999", b"\n\x03USD\x18\x81\xec\x94\xa3\xfc\xff\xff\xff\xff\x01"),
        (-0.9999999990, "-0.999999999", 0, -999999999, "", None, "-0.999999999", b"\x18\x81\xec\x94\xa3\xfc\xff\xff\xff\xff\x01"),
        ("-0.9999999994 USD", "-0.999999999 USD", 0, -999999999, "USD", "USD", "-0.999999999", b"\n\x03USD\x18\x81\xec\x94\xa3\xfc\xff\xff\xff\xff\x01"),
        (-0.9999999994, "-0.999999999", 0, -999999999, "", None, "-0.999999999", b"\x18\x81\xec\x94\xa3\xfc\xff\xff\xff\xff\x01"),
        ("-0.99999999949 USD", "-0.999999999 USD", 0, -999999999, "USD", "USD", "-0.999999999", b"\n\x03USD\x18\x81\xec\x94\xa3\xfc\xff\xff\xff\xff\x01"),
        (-0.99999999949, "-0.999999999", 0, -999999999, "", None, "-0.999999999", b"\x18\x81\xec\x94\xa3\xfc\xff\xff\xff\xff\x01"),
        ...
        (-1.9999999995, "-2.00", -2, 0, "", None, "-2", b"\x10\xfe\xff\xff\xff\xff\xff\xff\xff\xff\x01"),
        ("-1.4999999995", "-1.50", -1, -500000000, "", None, "-1.50", b"\x10\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x18\x80\xb6\xca\x91\xfe\xff\xff\xff\xff\x01"),
        (-1.4999999995, "-1.50", -1, -500000000, "", None, "-1.50", b"\x10\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x18\x80\xb6\xca\x91\xfe\xff\xff\xff\xff\x01"),
        ("-1.0999999905", "-1.099999991", -1, -99999991, "", None, "-1.099999991", b"\x10\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x18\x89\xbe\xa8\xd0\xff\xff\xff\xff\xff\x01"),
        (-1.0999999905, "-1.099999991", -1, -99999991, "", None, "-1.099999991", b"\x10\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x18\x89\xbe\xa8\xd0\xff\xff\xff\xff\xff\x01"),
        ("-0.0000000005 USD", "-0.000000001 USD", 0, -1, "USD", "USD", "-0.000000001", b"\n\x03USD\x18\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01"),
        (-0.0000000005, "-0.000000001", 0, -1, "", None, "-0.000000001", b"\x18\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01"),
        ("-0.0000000001 USD", "0.00 USD", 0, 0, "USD", "USD", "0", b"\n\x03USD"),
        (-0.0000000001, "0.00", 0, 0, "", None, "0", b""),
    ],
)
def test_protobuf_input(money_input: Any, str_output: str, units: int, nanos: int, proto_currency: str, currency_code: Optional[str], decimal_input: str, protobuf_bytes: bytes) -> None:
